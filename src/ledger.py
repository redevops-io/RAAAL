...
class Ledger:
    ...
    def _conn(self) -> Iterator[sqlite3.Connection]:
        ...
        rest without waiting for the port. `Porting it behind the engine is the real fix and is a named slice: it holds authoritative published evidence, and a second persistence identity is a second place single resolution can drift.`
        """
        ...
        try:
            ...
            raise translate(exc, operation="ledger") from exc
        finally:
            conn.close()
